...
class ShapeDrawPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
    ...
    private ArrayList<FaceDraw> animatedFaces;
    ...
    ShapeDrawPanel(ArrayList<OvalDraw> OvalDrawListIn) {
        ...
        panelAnimationTimer = new Timer(1000,this);
        panelAnimationTimer.start();

        animatedFaces = new ArrayList<FaceDraw>();
    }
